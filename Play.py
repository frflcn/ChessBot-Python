...
import io
from ChessRules import ChessBoard, Pawn, Rook, Bishop, Knight, King, Queen, NoPiece
...
def make_move(move):
    ...
    if stockfish.is_move_correct(move):
        ...
        stockfish.make_moves_from_current_position([result.move.uci()])
...
def show_available_moves():
    ...
    if piece_selected == None or isinstance(piece_selected, NoPiece):
        return
    squares_seen = piece_selected.attack_squares_seen()
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            elif isinstance(piece_selected, NoPiece) or piece_selected == None:
